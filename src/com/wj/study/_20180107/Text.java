...
public class Text {
	...
	public static void main(String[] args) {
		...
		if (sum == 1){
			...
			Car[] rent = {new Bus1(1 , "法拉利" , 100 , 0, 3,0),new Bus2(2 , "兰博基尼" , 200 , 0 , 4,0),new Truck1(3 , "拖拉机" , 300 , 1 , 0 , 3),new Truck2(4 , "东风风神" , 400 , 1 , 0 , 5),new PickUp(5 , "皮卡车" , 500 , 2 , 2, 3)};//可以用任何类型来定义
